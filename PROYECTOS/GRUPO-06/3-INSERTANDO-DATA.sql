...
DATAFILE 'C:\app\alumno\oradata\orcl\DF_ADMIN.DBF'
SIZE 10M;

CREATE TABLESPACE TBS_CONSULTA
DATAFILE 'C:\app\alumno\oradata\orcl\DF_CONSULTA.DBF'
SIZE 10M;

CREATE TABLESPACE TBS_SISTEMA
DATAFILE 'C:\app\alumno\oradata\orcl\DF_SISTEMA.DBF'
SIZE 10M;

CREATE TABLESPACE TBS_AUDITORIA
DATAFILE 'C:\app\alumno\oradata\orcl\DF_AUDITORIA.DBF'
SIZE 10M;
